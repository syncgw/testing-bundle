	...
	public function testClass(string $typ, float $ver, string $xpath): void {
		...
		if ($typ == 'application/activesync.mail+xml') {
			...
			$cmp2->loadXML('<Data><'.$xpath.' xml-ns="activesync:Mail"><BusyStatus>3</BusyStatus>'.
					...
					'<GlobalObjId xml-ns="activesync:Mail">BAAAAIIA4AB0xbcQGoLgCAAAAAAAAAAAAAAAAAAAAAB/AAAAdkNhbC1VaWQBAAAAezA0MDAwMDAwODIwMGUwMDA3NGM1YjcxMDFhODJlMDA4MzAzMDMwMTBlMDQwYzljMTI2ODVjNDAxMDAwMDAwMDAwMDAwMDAwMDEwMDAwMDAwMGJmMGVkNGI2ZTRlZTk0ZTllMzllMzg2N2IzNzhlZjN9AA==</GlobalObjId>'.
					'<InstanceType>3</InstanceType><Location xml-ns="activesync:AirSyncBase">'.
					'<DisplayName>somewhere</DisplayName></Location>'.
					...
					'<WeekOfMonth>1</WeekOfMonth></Recurrence></Recurrences>'.
					'<ReminderTime xml-ns="activesync:Tasks">33</ReminderTime>'.
					'<ResponseRequested xml-ns="activesync:Mail">1</ResponseRequested>'.
					'<Sensitivity>2</Sensitivity><StartTime>2011-11-21T00:00:00.000Z</StartTime></'.$xpath.'></Data>');
		}
